...
- `File Encryptor` –  A DSA based project - File ecryption and decryption with Huffman Coding Algorithm(Greedy) in Java, Springboot, and React.js.
- `Resume Builder` –  Resume Builder to register, login, and authenticate user and create, update, delete resume. Integerated JWT authentication and password encoder using BCrypt and email verification using brevo.
...
- `Management System` –  Management System(CRUD) full-stack application.
