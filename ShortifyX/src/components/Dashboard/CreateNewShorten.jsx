...
const CreateNewShorten = ({ setOpen, refetch }) => {
  ...
  return (
    <div className='flex justify-center items-center bg-white rounded-md'>
        ...
        <hr className="mt-2 sm:mb-5 mb-3 text-slate-850" />
        ...
        <button
          className="btn-gradient font-semibold text-white w-32  bg-custom-gradient  py-2  transition-colors  rounded-md my-3"
          type="text"
        >
         ...
         {!loading && (
          <Tooltip title="Close">
            ...
            >
              <RxCross2 className="text-slate-800 cursor-pointer  text-3xl" />
            </button>
          </Tooltip>
        )}
